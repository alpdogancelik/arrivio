...
export default function RegisterScreen() {
  ...
  const onRegister = async () => {
    setLoading(true);
    const res = await register({ name, surname, email: email.trim(), password });
    setLoading(false);
    if (!res.ok) {
    ...
    Alert.alert(t('registerTitle'), t('registrationSuccess'));
    ...
    <View style={styles.container}>
      ...
      <ThemedView style={styles.centerCard}>
        <ThemedView style={styles.card}>
          ...
          <GradientButton onPress={onRegister} disabled={loading}>
