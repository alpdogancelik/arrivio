...
export default function BookingsIndexScreen() {
  ...
  const ListState = isLoading ? (
    <ScreenState
      ...
      message={t("booking:loadingBookings", { defaultValue: "Loading bookings..." })}
      compact
    ...
    <ScreenState
      mode="error"
      title={t("booking:bookingsCouldNotLoad")}
      message={
    ...
    <ScreenState
      ...
      style={styles.stateCard}
      footer={
        <Pressable onPress={() => router.push("/bookings/new")} style={[styles.stateBtn, styles.stateBtnPrimary, { alignSelf: "stretch", marginTop: 12 }]}>
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <FlatList
        ...
        contentContainerStyle={[styles.list, { paddingBottom: Ui.layout.tabBarOffset + insets.bottom }]}
        refreshControl={
          <RefreshControl
