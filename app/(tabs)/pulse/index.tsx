...
const shadow = Platform.select({
  ...
  android: { elevation: 6 },
  default: { boxShadow: "0px 10px 28px rgba(0, 0, 0, 0.25)" } as any,
});
      ...
      >
        ...
        <ThemedView style={styles.hero}>
          ...
          <Image
            ...
            style={[styles.heroArt, Platform.OS === "web" ? ({ pointerEvents: "none" } as any) : null]}
            contentFit="contain"
          />
        </ThemedView>
...
const styles = StyleSheet.create({
  ...
  cardArt: { position: "absolute", width: 120, height: 120, opacity: 0.16 },
